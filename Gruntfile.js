...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      main: {
        ...
        files: [createFolderGlobs(['*.js', '*.less', '*.html']), '!_SpecRunner.html', '!.grunt', '!Templates/**'],
    ...
    copy: {
      main: {
        files: [
          {src: ['assets/**', '!Templates/**', '.htaccess'], dest: 'dist/'},
    ...
    cssmin: {
      main: {
        ...
        dest: 'dist/app/app.full.min.css'
      }
    },
    concat: {
      main: {
  ...
  grunt.registerTask('build', ['jshint', 'clean:before', 'less', 'dom_munger', 'ngtemplates',
    'cssmin', 'concat', 'ngAnnotate', 'uglify', 'copy', 'htmlmin', 'clean:after']);
